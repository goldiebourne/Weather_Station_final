<template>
  ...
  <VContainer class="fill-height ">
    <VResponsive class="align-center text-center fill-height">
      <VImg height="350" class="mb-5" src="file:///C:/Users/gldbo/Downloads/reshot-icon-weather-EJPNZMV8U5.svg" />
      ...
      <div class="text-body-1 font-weight-light mt-1" style="color: orange;">Weather Station</div>
